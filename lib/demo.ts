...
export const demoArenaData: ArenaData = {
  ...
  tournamentDraws: [],
  tournamentTeams: teams.map((team, index) => ({
    tournament_id: activeTournament.id,
    team_id: team.id,
    group_code: index < 2 ? "A" : "B",
    seed: index % 2 + 1,
    status: "approved"
  })),
  venues,
  ...
  adCampaigns: [
    {
      ...
      body: "Sorteos, vivos y finales",
      logo_url: null,
      target_url: "https://www.youtube.com/@FulbitoLIVE?sub_confirmation=1",
      placement: "arena_led",
      scope: "national",
      latitude: null,
      longitude: null,
    ...
    {
      id: "demo-ad-fulbito-live",
      created_by: null,
      approved_by: null,
      advertiser_name: "Fulbito Live",
      headline: "Fulbito Live",
      body: "Transmisiones por YouTube",
      logo_url: null,
      target_url: "https://www.youtube.com/@FulbitoLIVE?sub_confirmation=1",
      placement: "arena_led",
      scope: "national",
